            ...
            <DataTable ref="dt" :value="tableResult" responsiveLayout="scroll" :rowsPerPageOptions="[10, 20, 50]" :filters="filters" :paginator="true" :rows="10">
                ...
                <Column field="items" :header="$t('dtc.values')" style="min-width:200px">
                    ...
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[0][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[0][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[0][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[0][2] * slotProps.data.array_agg[0][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="FEB">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[1][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[1][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[1][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[1][2] * slotProps.data.array_agg[1][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="MAR">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[2][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[2][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[2][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[2][2] * slotProps.data.array_agg[2][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                    ...
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[3][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[3][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[3][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[3][2] * slotProps.data.array_agg[3][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="MAI">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[4][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[4][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[4][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[4][2] * slotProps.data.array_agg[4][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="JUN">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[5][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[5][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[5][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[5][2] * slotProps.data.array_agg[5][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="JUL">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[6][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[6][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[6][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[6][2] * slotProps.data.array_agg[6][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="AUG">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[7][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[7][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[7][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[7][2] * slotProps.data.array_agg[7][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="SEP">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[8][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[8][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[8][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[8][2] * slotProps.data.array_agg[8][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="OCT">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[9][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[9][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[9][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[9][2] * slotProps.data.array_agg[9][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="NOV">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[10][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[10][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[10][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[10][2] * slotProps.data.array_agg[10][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
                <Column field="items" header="DEC">
                    <template v-if="typeSelected.value === 'raw'" #body="slotProps">
                        <tr>
                            <td>{{(slotProps.data.array_agg[11][0]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[11][1]).toFixed(fixed.value)}}</td>
                        </tr>
                        <tr>
                            <td>{{(slotProps.data.array_agg[11][2]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                    <template v-else #body="slotProps">
                        <tr>
                        ...
                        <tr>
                            <td>{{(slotProps.data.array_agg[11][2] * slotProps.data.array_agg[11][1]).toFixed(fixed.value)}}</td>
                        </tr>
                    </template>
                </Column>
            </DataTable>
