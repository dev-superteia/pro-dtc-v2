            ...
            aux_materials as (
                ...
                from
                    (select componentes.plant,
                        ...
                        (case when mez2.utilization = 0 then mez2.qtd_without else mez2.utilization end) * componentes.utilization as raw_weight,
                        mez2.month,
                        componentes.year,
                        '1' as type,
                        volum
                    ...
                    select componentes.plant,
                        componentes.component as material,
                        mez2.component as raw_material,
                        (case when mez2.utilization = 0 then mez2.qtd_without else mez2.utilization end) * componentes.comp_weight as raw_weight,
                        mez2.month,
                        componentes.year,
                        '4' as type,
                        volum
